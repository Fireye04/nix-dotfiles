{
	...
	programs.niri = {
		...
		config = ''
						...
						output "LG Electronics LG ULTRAWIDE 0x00000CDE" {
						...
						workspace "M";
						window-rule {
						  match at-startup=true title="spotify_player"
						exclude app-id="zen"
						  open-on-workspace "M"
						}
			...
			tofi-drun --drun-launch=true --font /usr/share/fonts/noto/NotoSansMono-Regular.ttf || pkill tofi-drun
			"; }
						...
						Mod+A {spawn "hyprpicker" "-a" "-n";}
						  ...
						  // These binds will change direction based on the natural-scroll setting.l
						  //
						  ...
						  Mod+Shift+S { move-column-to-workspace "M"; }
