{
	...
	home.file.".local/share/godot/export_templates/${builtins.replaceStrings ["-"] ["."] pkgs.godotPackages.export-template-mono.version}.mono".source = "${pkgs.godotPackages.export-template-mono.outPath}";
