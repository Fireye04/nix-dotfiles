...
# and in the NixOS manual (accessible by running ‘nixos-help’).
{
	...
	programs.nix-ld = {
		enable = true;
		libraries = options.programs.nix-ld.libraries.default ++ (with pkgs; [xorg.libSM xorg.libICE xorg.libXrender xorg.libXext xorg.libX11 libGL libGLU glib libpulseaudio libnss_nis]);
	};
